...
class TestSuiteAssignment(unittest.TestCase):
    ...
    def test_explanatory_report_zero_outputs(self):
        ...
        PlanItHelper.run_test_with_zero_flow_outputs(assignment_project, max_iterations, epsilon, description, 1, project_path)
    ...
    def test_explanatory_with_memory_output(self):
        ...
        key2_position = assignment_project.memory.get_position_of_output_key_property(OutputType.PATH, OutputProperty.DESTINATION_ZONE_XML_ID)
        memory_output_iterator_path = assignment_project.memory.iterator(mode_xml_id, time_period_xml_id, max_iterations, OutputType.PATH)
        ...
        od_position = assignment_project.memory.get_position_of_output_value_property(OutputType.OD, OutputProperty.OD_COST)
        key1_position = assignment_project.memory.get_position_of_output_key_property(OutputType.OD, OutputProperty.ORIGIN_ZONE_XML_ID)
        key2_position = assignment_project.memory.get_position_of_output_key_property(OutputType.OD, OutputProperty.DESTINATION_ZONE_XML_ID)
        memory_output_iterator_od = assignment_project.memory.iterator(mode_xml_id, time_period_xml_id, max_iterations-1, OutputType.OD)
    ...
    def test_2_SIMO_MISO_route_choice_single_mode_with_initial_costs_and_one_iteration_and_three_time_periods(self):
        ...
        assignment_project.initial_cost.set(os.path.join("route_choice", "xml", "SIMOMISOrouteChoiceInitialCostsOneIterationThreeTimePeriods", "initial_link_segment_costs_time_period_1.csv"), timePeriod0XmlId)
        assignment_project.initial_cost.set(os.path.join("route_choice", "xml", "SIMOMISOrouteChoiceInitialCostsOneIterationThreeTimePeriods", "initial_link_segment_costs_time_period_2.csv"), timePeriod1XmlId)
        assignment_project.initial_cost.set(os.path.join("route_choice", "xml", "SIMOMISOrouteChoiceInitialCostsOneIterationThreeTimePeriods", "initial_link_segment_costs_time_period_3.csv"), timePeriod2XmlId)
    ...
    def test_2_SIMO_MISO_route_choice_single_mode_with_initial_costs_and_500_iterations(self):
        ...
        plan_it = Planit()
        assignment_project = plan_it.create_project(project_path)
        assignment_project.initial_cost.set(os.path.join("route_choice", "xml", "SIMOMISOrouteChoiceSingleModeWithInitialCosts500Iterations", "initial_link_segment_costs.csv"))        
