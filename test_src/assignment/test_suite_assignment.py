...
class TestSuiteAssignment(unittest.TestCase):
    ...
    def test_explanatory_report_zero_outputs(self):
        ...
        project_path = os.path.join(ABSOLUTE_PATH_TEST_DATA, 'explanatory', 'reportZeroOutputs')
        plan_it = Planit()
    ...
    def test_2_SIMO_MISO_route_choice_single_mode_with_initial_costs_and_one_iteration_and_three_time_periods(self):
        ...
        project_path = os.path.join(ABSOLUTE_PATH_TEST_DATA, 'route_choice', 'xml',
        ...
        assignment_project.initial_cost.set(
            os.path.join(ABSOLUTE_PATH_TEST_DATA, "route_choice", "xml", "SIMOMISOrouteChoiceInitialCostsOneIterationThreeTimePeriods",
    ...
    def test_5_SIMO_MISO_route_choice_two_modes(self):
        ...
        # prep
        project_path = os.path.join(ABSOLUTE_PATH_TEST_DATA, 'route_choice', 'xml', 'SIMOMISOrouteChoiceTwoModes')
        ...
        assignment_project.assignment.od_configuration.deactivate(SkimSubOutputType.NONE)
    ...
    def test_2_SIMO_MISO_route_choice_single_mode_with_initial_costs_and_500_iterations(self):
        ...
        project_path = os.path.join(ABSOLUTE_PATH_TEST_DATA, 'route_choice', 'xml', 'SIMOMISOrouteChoiceSingleModeWithInitialCosts500Iterations')
        ...
        assignment_project = plan_it.create_project(project_path)
        assignment_project.initial_cost.set(
            os.path.join(project_path, "initial_link_segment_costs.csv"))
    ...
    def test_4_bi_directional_links_route_choice_single_mode_with_two_time_periods(self):
        ...
        project_path = os.path.join(ABSOLUTE_PATH_TEST_DATA, 'route_choice', 'xml', 'biDirectionalLinksRouteChoiceSingleModeWithTwoTimePeriods')
    ...
    def test_mode_test(self):
        ...
        project_path = os.path.join(ABSOLUTE_PATH_TEST_DATA, 'mode_test', 'xml', 'simple')
    ...
    def test_basic_shortest_path_algorithm_a_to_c(self):
        ...
        project_path = os.path.join(ABSOLUTE_PATH_TEST_DATA, 'basicShortestPathAlgorithm', 'xml', 'AtoC')
    ...
    def test_basic_shortest_path_algorithm_a_to_d(self):
        ...
        project_path = os.path.join(ABSOLUTE_PATH_TEST_DATA, 'basicShortestPathAlgorithm', 'xml', 'AtoD')
    ...
    def test_basic_shortest_path_algorithm_three_time_periods(self):
        ...
        project_path = os.path.join(ABSOLUTE_PATH_TEST_DATA, 'basicShortestPathAlgorithm', 'xml', 'ThreeTimePeriods')
