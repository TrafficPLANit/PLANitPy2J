...
class PlanItHelper:
    ...
    def run_test(
        ...
        planit.assignment.od_configuration.deactivate(SkimSubOutputType.NONE)
    ...
    def run_test_with_zero_flow_outputs(plan_it: PlanitProject, max_iterations, epsilon, description,
        ...
        plan_it.assignment.od_configuration.deactivate(SkimSubOutputType.NONE)
    ...
    @staticmethod
    def run_test_without_activating_outputs(plan_it: PlanitProject, max_iterations, epsilon, description,
                                            output_type_configuration_option, project_path=None,
                                            deactivate_file_output=False):
