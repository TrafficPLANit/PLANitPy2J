...
class Helper:
    ...
    def run_test(plan_it,
        ...
        plan_it.initialize_project(project_path)
        ...
        if output_type_configuration_option == 1:
            plan_it.assignment.link_output_type_configuration.remove_property(OutputProperty.TIME_PERIOD_EXTERNAL_ID)
            plan_it.assignment.link_output_type_configuration.remove_property(OutputProperty.TIME_PERIOD_ID)
            plan_it.assignment.link_output_type_configuration.remove_property(OutputProperty.MAXIMUM_SPEED)
            plan_it.assignment.link_output_type_configuration.remove_property(OutputProperty.TOTAL_COST_TO_END_NODE)
        elif output_type_configuration_option == 2:
            plan_it.assignment.link_output_type_configuration.remove_property(OutputProperty.TIME_PERIOD_EXTERNAL_ID)
            plan_it.assignment.link_output_type_configuration.remove_property(OutputProperty.TIME_PERIOD_ID)
            plan_it.assignment.link_output_type_configuration.remove_property(OutputProperty.TOTAL_COST_TO_END_NODE)
            plan_it.assignment.link_output_type_configuration.remove_property(OutputProperty.DOWNSTREAM_NODE_EXTERNAL_ID)
            plan_it.assignment.link_output_type_configuration.remove_property(OutputProperty.UPSTREAM_NODE_EXTERNAL_ID)
        ...
        plan_it.assignment.origin_destination_output_type_configuration.remove_property(OutputProperty.TIME_PERIOD_EXTERNAL_ID)
        plan_it.assignment.origin_destination_output_type_configuration.remove_property(OutputProperty.RUN_ID)
        ...
        xml_output_formatter_counterpart = plan_it.project.create_and_register_output_formatter(OutputFormatter.PLANIT_IO.value)
        xml_output_formatter = PlanItOutputFormatterWrapper(xml_output_formatter_counterpart)
        plan_it.assignment.set(xml_output_formatter)
        plan_it.assignment.xml_output_formatter.set_xml_name_root(description)
        plan_it.assignment.xml_output_formatter.set_csv_name_root(description)
        plan_it.assignment.xml_output_formatter.set_output_directory(project_path)
